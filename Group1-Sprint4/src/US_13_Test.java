...
public class US_13_Test extends TestCase{

	
	public US_13_Test(String testMethod){
		super(testMethod);
	}
	...
	public static Test suite(){
		...
		suite.addTest(new US_13_Test("testFetchDay"));
		suite.addTest(new US_13_Test("testDateListToString"));
		return suite;
	}
	...
	public void testDateListToString(){
		...
		assertEquals(testDate1, DateFunc.dateListToString(testDateList1));
		assertFalse(testDate1.equals(DateFunc.dateListToString(testDateList2)));
		System.out.println("Done.");
	}
