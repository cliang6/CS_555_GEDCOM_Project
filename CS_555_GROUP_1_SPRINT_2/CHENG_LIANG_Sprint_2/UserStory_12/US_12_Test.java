...
public class US_12_Test extends TestCase{

	
	public US_12_Test(String testMethod){
		super(testMethod);
	}
	...
	public static Test suite(){
		...
		suite.addTest(new US_12_Test("testDateCompare"));
		suite.addTest(new US_12_Test("testFetchDay"));
		suite.addTest(new US_12_Test("testDateStringToList"));
		return suite;
	}
	...
	public void testDateCompare(){
		...
		assertTrue(DateFunc.dateCompare(birth, death).equals("<"));
		assertTrue(DateFunc.dateCompare(death, birth).equals(">"));
		assertTrue(DateFunc.dateCompare(birth, birth).equals("="));
		assertFalse(DateFunc.dateCompare(birth, death).equals(">"));
		assertFalse(DateFunc.dateCompare(death, death).equals("<"));
		assertFalse(DateFunc.dateCompare(death, birth).equals("="));
		System.out.println("Done.");
	}
