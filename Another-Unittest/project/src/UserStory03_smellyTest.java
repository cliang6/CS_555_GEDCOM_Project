...
public class UserStory03_smellyTest {
    ...
    public void checkBirthDateBeforeDeathDateForIndi() {
        ...
        String act1 = UserStory03_smelly.checkBirthDateBeforeDeathDateForIndi(idlist1,falist);
        String act2 = UserStory03_smelly.checkBirthDateBeforeDeathDateForIndi(idlist2,falist);
        String act3 = UserStory03_smelly.checkBirthDateBeforeDeathDateForIndi(idlist3,falist);
        String act4 = UserStory03_smelly.checkBirthDateBeforeDeathDateForIndi(idlistfalse,falist);
