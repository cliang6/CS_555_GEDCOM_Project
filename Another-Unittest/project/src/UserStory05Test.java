...
public class UserStory05Test {
    ...
    public void checkWeddDateBeforeDeathDateForIndi() {
        ...
        List<String> id4 = new ArrayList<String>(Arrays.asList("I01", "mike","male","1900-01-01","-20", "True","1930-01-01","None","{'F01'}"));
        idlistfalse.add(id3);
        idlistfalse.add(id4);
        ...
        String act1 = UserStory05.checkWeddDateBeforeDeathDateForIndi(idlist,falist);
        String act2 = UserStory05.checkWeddDateBeforeDeathDateForIndi(idlistfalse,falist);
