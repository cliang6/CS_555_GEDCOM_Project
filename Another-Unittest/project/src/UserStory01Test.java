...
public class UserStory01Test {
    ...
    @Test
    public void checkBirthDateBeforeCurrentForIndi() {
        List<List<String>> idlist = new ArrayList<List<String>>();
        List<String> id2 = new ArrayList<String>(Arrays.asList("I01", "mike","male","2000-01-01","-20", "True","2030-01-01","None","{'F01'}"));
        ...
        List<String> id4 = new ArrayList<String>(Arrays.asList("I01", "mike","male","2020-01-01","-20", "True","1930-01-01","None","{'F01'}"));
        idlistfalse.add(id3);
        idlistfalse.add(id4);
        ...
        String exp1 = "";
        String exp2 = "ERROR: Family: US05: " + "I01" + " Married " + "2000-01-01" + " after "+ "I01" + "("+"F01"+")"+" death on " + "1930-01-01";
        String act1 = UserStory01.checkBirthDateBeforeCurrentForIndi(idlist,falist);
        String act2 = UserStory01.checkBirthDateBeforeCurrentForIndi(idlistfalse,falist);
    ...
    @Test
    public void checkDeathDateBeforeCurrentForIndi() {
    }

    @Test
    public void checkMarriageDateBeforeCurrentForFam() {
    }

    @Test
    public void checkDivorceDateBeforeCurrentForFam() {
    }
}
