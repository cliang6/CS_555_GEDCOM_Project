...
public class UserStory01 {
    ...
    public static void checkBirthDateBeforeCurrentForIndi(List<List<String>> idList, List<List<String>> faList){
        try{
            String res = "";
    ...
    public static void checkDeathDateBeforeCurrentForIndi(List<List<String>> idList, List<List<String>> faList){
        try {
            String res = "";
            Calendar cal = Calendar.getInstance();
            int currentDay, currentMonth, currentYear;
    ...
    public static void checkMarriageDateBeforeCurrentForFam(List<List<String>> idList, List<List<String>> faList){
        try {
            String res = "";
            Calendar cal = Calendar.getInstance();
            int currentDay, currentMonth, currentYear;
    ...
    public static void checkDivorceDateBeforeCurrentForFam(List<List<String>> idList, List<List<String>> faList){
        try {
            String res = "";
            Calendar cal = Calendar.getInstance();
            int currentDay, currentMonth, currentYear;
