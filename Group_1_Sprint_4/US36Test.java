...
public class US36Test {

    @Test
    public void listRecentDeaths() {
    }
    ...
    public void listrecentdeaths() {
        ...
        List<String> id2 = new ArrayList<String>(Arrays.asList("I01", "mike/J","male","2000-11-01","-20", "True","2018-11-01","None","{'F01'}"));
        idlist.add(id);
        idlist.add(id2);
        ...
        List<String> id4 = new ArrayList<String>(Arrays.asList("I02", "tom/J","male","1900-10-20","-20", "True","2010-01-01","None","{'F02'}"));
        ...
        List<String> id6 = new ArrayList<String>(Arrays.asList("I03", "jack/J","male","1900-11-20","-20", "True","NA","None","{'F03'}"));
        ...
        String act1 = US36.listrecentdeaths(idlist,falist);
        String act2 = US36.listrecentdeaths(idlistupcoming1,falist);
        String act3 = US36.listrecentdeaths(idlistupcoming2,falist);
